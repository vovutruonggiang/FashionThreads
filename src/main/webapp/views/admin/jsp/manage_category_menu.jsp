							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="tab1" role="tabpanel">
									<div class="card">
										...
										<!-- /.card-header -->
										<div class="card-body">
											<form:form modelAttribute="category_menu">
												<div class="text"></div>
												<div class="row">
													...
													<label for="labelUsername" class="col-form-label">Tên
														Menu </label>
													<div class="col-sm-6">
														<form:input path="name_category_menu" type="text"
															class="form-control" />
													</div>
												</div>
												<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<table id="example1"
												...
												<tbody>
													<c:forEach items="${list_category_menu}" var="item">
														<tr>
															<td>${item.id}</td>
															<td>${item.name_category_menu}</td>
															<td>
																<div class="drop-left">
																	<span><a
