...
<title>Quản Lý Tài Khoản | Fashion Thread</title>
					...
					<div class="row">
						<div class="col-12">
							<div class="div_tabs">
								...
								<div class="div_tabs2">
									<a href="/views/manage_account_fashion_threads">Tài Khoản </a>
								</div>
							</div>
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="tab1" role="tabpanel">
									<div class="card">
										...
										<!-- /.card-header -->
										<div class="card-body">
											<form:form modelAttribute="account" id="myForm">
												<div class="text"></div>
												<div class="row">
												...
												<div class="row">
													<label for="labelPass" class="col-form-label">Mật
														Khẩu:</label>
													<div class="col-sm-6">
														<form:input path="password" type="password" name="pass"
															id="inputField4" class="form-control" />
													</div>
												</div>
												<div class="row">
													<div class="btn-function">
														<a href="/views/manage_account_fashion_threads"
															class="btn btn-info">Mới</a>
														<button
															formaction="/views/manage_account_fashion_threads/insert"
															class="btn btn-success">Thêm</button>
														<button
															formaction="/views/manage_account_fashion_threads/update"
													...
													<c:forEach items="${accounts}" var="account">
														<tr>
															...
															<td>
																<div class="drop-left">
																	<span><a
																		href="/views/manage_account_fashion_threads/edit/${account.username}"
