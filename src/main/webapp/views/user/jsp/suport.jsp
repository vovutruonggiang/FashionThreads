                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl">
                        ...
                        <div class="oder-block-acount">
                            <p>
                                "Vì chính sách an toàn thẻ, bạn không thể thay đổi SĐT, Ngày sinh, Họ tên. Vui lòng liên
                                hệ CSKH 0837225435 để được hỗ trợ"
                            </p>
                            <div>
                                <form style="display: block;">
                                    <div class="form-group" style="width: 630px;">
                                        <div class="label">
                                            <label style="width: 170px;">Họ và Tên</label>
                                        </div>
                                        <div class="input">
                                            <input value="Lê Vĩ Phú" type="text" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 630px;">
                                        <div class="label">
                                            <label style="width: 170px;">Số điện thoại</label>
                                        </div>
                                        <div class="input">
                                            <input value="0837225435" type="text" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 630px;">
                                        <div class="label">
                                        ...
                                        <div class="input">
                                            <input value="phucm2019@gmail.com" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 630px;">
                                        <div class="label">
                                            <label style="width: 170px;">Ngày sinh</label>
                                        </div>
                                        <div class="input">
                                            <input value="23/04/2003" type="text" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 630px;">
                                        <div class="label">
                                            <label style="width: 170px;">Giới tính</label>
                                        </div>
                                        <div class="input">
                                            <div>
                                                <label for="">
                                    ...
                                    <div class="form-group" style="width: 630px;">
                                        <button class="btn-lage" style="margin-left: 170px;">Cập nhật</button>
                                        <button class="btn-lage">Đổi mật khẩu</button>
