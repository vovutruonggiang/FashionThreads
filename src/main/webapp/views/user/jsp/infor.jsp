...
<title>Thông tin tài khoản | IVY moda</title>
<link rel="canonical" href="https://ivymoda.com/customer/info" />
<meta property="og:url" content="https://ivymoda.com/customer/info" />
<meta property="og:title" content="Thông tin tài khoản  | IVY moda" />
...
<script type="text/javascript">
	...
	var now = parseDateTime('2023-11-15 14:40:41');
			...
			<div class="breadcrumb-products">
				<ol class="breadcrumb__list">
					<li class="breadcrumb__item"><a class="breadcrumb__link"
						href="/views/home">Trang chủ</a></li>
					<li class="breadcrumb__item"><a
						href="https://ivymoda.com/customer/info" class="breadcrumb__link"
						title="Tài khoản của tôi">Tài khoản của tôi</a></li>
				</ol>
			</div>
			...
			<div class="order-wrapper mt-40 my-account">
				<div class="row">
					<div class="col-lg-4 col-xl-auto">
						<div class="order-sidemenu block-border">
							...
							<!--                        <li role="presentation" class="active"><a href="https://ivymoda.com/customer/info" aria-controls="bangthongtintaikhoan">Bảng thông tin tài khoản</a></li>-->
					...
					<div class="col-lg-8 col-xl">
						...
						<div class="order-block my-account-wrapper row">
							<p class="alert alert-primary">"Vì chính sách an toàn thẻ,
								bạn không thể thay đổi SĐT, Ngày sinh, Họ tên. Vui lòng liên hệ
								CSKH 0905898683 để được hỗ trợ"</p>
							<div class="col-md-7">
								<form:form method="post" action="info/update"
									modelAttribute="infor">
									<div hidden="">
										<form:input path="id" value="${staffs.id}" />
									</div>
									<div hidden="">
										<form:input path="address" value="${staffs.address}" />
									</div>
 									<div class="row form-group">
										...
										<div class="col col-input">
											<form:input path="fullname" class="form-control"
												value="${staffs.fullname}" type="text"
												disabled="disabled" />
										</div>
									</div>
									<div class="row form-group">
										...
										<div class="col col-input has-button">
											<form:input path="phone_number"
												value="${staffs.phone_number}" class="form-control"
												type="text" id="customer_phone" disabled="disabled" />
										</div>
									</div>
									<div class="row form-group">
										<div class="col col-label">
										...
										<div class="col col-input has-button">
											<form:input class="form-control" type="text"
												value="${staffs.email}" id="customer_email"
												path="email" />
										</div>
									</div>
											...
											<div class="row">
												<div class="form-group col-12">
													<label class="form-radio">
													 <input
														class="form-radio__input" type="radio" name="sex"
														value="1" checked /><span class="form-radio__label">Nam</span>
													</label> <label class="form-radio"> 
													<input
														class="form-radio__input" type="radio" name="sex"
														value="0" /><span class="form-radio__label">Nữ</span>
													</label> 
												</div>
											</div>
										</div>
									...
									<div class="row form-radio-checkbox form-group">
										...
										<div class="col col-input">
											<div class="row">
												<form:input path="years" type="text"
													value="${staffs.years}" class="form-control"
													disabled="disabled" />
											</div>
										</div>
									</div>
				...
				<div class="add-address add-change-pass" id="fancybox-popup">
					...
					<div class="col-md-12 form-group">
						<label>Mật khẩu hiện tại</label> <input class="form-control"
							type="password" name="customer_pass_old" id="customer_pass_old">
					</div>
					<div class="col-md-12 form-group">
						<label>Mật khẩu mới</label> <input class="form-control"
							type="password" name="customer_pass_new1" id="customer_pass_new1"
							value="">
					</div>
					<div class="col-md-12 form-group">
						<label>Nhập lại Mật khẩu mới</label> <input class="form-control"
							type="password" name="customer_pass_new2" id="customer_pass_new2"
							value="">
					</div>
					<div class="wallet-deposit-form-wrapper" style="width: 100%">
						<div class="col-md-12 form-button">
							<a style="max-width: 100%; font-weight: 600;"
								class="btn btn--large" id="change_pass">Cập nhật</a>
						</div>
					</div>
				</div>
