...
<title></title>
<link rel="canonical"
	href="https://ivymoda.com/customer/san-pham-yeu-thich" />
<meta property="og:url"
	content="https://ivymoda.com/customer/san-pham-yeu-thich" />
...
<script type="text/javascript">
	...
	var now = parseDateTime('2023-11-15 15:08:02');
			...
			<div class="breadcrumb-products">
				<ol class="breadcrumb__list">
					...
					<li class="breadcrumb__item"><a
						href="https://ivymoda.com/customer/san-pham-yeu-thich"
						class="breadcrumb__link" title="Sản phẩm yêu thích">Sản phẩm
							yêu thích</a></li>
				</ol>
			</div>

			<div class="order-wrapper mt-40 product-viewed">
				<div class="row">
					...
					<div class="col-lg-8 col-xl col-product-view-like">
						...
						<div class="sub-main-prod" id="products">
							<div class="list-products list-products-cat d-flex">
								<c:forEach var="list_favorite" items="${list_favorite}">
									<c:choose>
										<c:when
											test="${list_favorite.account_id.username eq user}">
											<div class="item-cat-product">
												<div class="product">
													<div class="info-ticket ticket-news">NEW</div>
													<div class="thumb-product">
														<a href=""> <img
															src="/views/image/${list_favorite.product_id.image}"
															alt="Đầm Organza phối hoa" class="lazy" /> <!-- 															<img -->
															<!-- 															src="https://pubcdn.ivymoda.com/files/product/thumab/400/2023/11/06/95e5d7428f0de0e20742bab9fed70be9.jpg" -->
															<!-- 															alt="Đầm Organza phối hoa" class="hover-img lazy" /> -->
														</a>
													</div>
														...
														<div class="list-color">
															<ul>
																<li><a href="javascript:void(0)"
																	class="color-picker" data-id="38874"> <img
																		src="https://pubcdn.ivymoda.com/ivy2/images/color/001.png"
																		alt="001" class="lazy" />
																</a></li>
																<li class="checked"><a href="javascript:void(0)"
																	class="color-picker" data-id="38875"> <img
																		src="https://pubcdn.ivymoda.com/ivy2/images/color/049.png"
																		alt="049" class="lazy" />
																</a></li>
															</ul>
															<div class="favourite">
																<a href="/views/favorite/delete/${list_favorite.id}">
																	<i class="icon-ic_heart"></i>
																</a>
															</div>
														</div>
														<h3 class="title-product">
															<a href="">${list_favorite.product_id.product_name}</a>
														</h3>
														<div class="price-product">
															<ins>
																<span>${list_favorite.product_id.price}</span>
															</ins>
														</div>
													</div>
													...
													<div class="list-size">
														<ul>
															<li data-product-sub-id="189237"><button
																	class="btn bt-large">s</button></li>
															<li data-product-sub-id="189265"><button
																	class="btn bt-large">m</button></li>
															<li data-product-sub-id="189291"><button
																	class="btn bt-large">l</button></li>
															<li data-product-sub-id="189315"><button
																	class="btn bt-large">xl</button></li>
															<li data-product-sub-id="189337"><button
