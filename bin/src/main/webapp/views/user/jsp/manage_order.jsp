...
<title>Danh sách đơn hàng | IVY moda</title>
<link rel="canonical" href="https://ivymoda.com/customer/order_list" />
<meta property="og:url"
	content="https://ivymoda.com/customer/order_list" />
<meta property="og:title" content="Danh sách đơn hàng | IVY moda" />
...
<script type="text/javascript">
	...
	var now = parseDateTime('2023-11-15 14:56:46');
			...
			<div class="breadcrumb-products">
				<ol class="breadcrumb__list">
					...
					<li class="breadcrumb__item"><a
						href="https://ivymoda.com/customer/order_list"
						class="breadcrumb__link" title="Quản lý đơn hàng">Quản lý đơn
							hàng</a></li>
				</ol>
			</div>

			<div class="order-wrapper mt-40 my-order">
				<div class="row" ng-app="myApp" ng-controller="orderCtrl">
						...
						<div class="order-sidemenu block-border">
							...
							<div class="order-sidemenu__menu">
								<ul>
									...
									<li class=""><a href=""><span class="icon-ic_padlock"></span>Lịch
											sử đăng nhập</a></li>
							...
							<!--                        <li role="presentation" class=""><a href="https://ivymoda.com/customer/address_list" aria-controls="sodiachi">Địa chỉ nhận hàng</a></li>-->
							<!--                        <li role="presentation" class="active"><a href="https://ivymoda.com/customer/order_list/" aria-controls="quanlydonhang">Quản lý đơn hàng</a></li>-->
							<!--                    </ul>-->
							<!--                </div>-->
							<!--            </div>-->
							<!--        </div>-->
					...
					<div class="col-lg-8 col-xl col-account-content">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
										<button class="dropdown-item" type="button">
											<a href="/form/order2">Tất cả</a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/dathangthanhcong">Đặt hàng thành công</a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/dangxuly">Đang xử lý </a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/chogiaovan">Chờ giao vận </a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/dagui">Đã gửi</a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/danhanhang">Đã nhận hàng</a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/dahuy">Đã hủy</a>
										</button>
										<button class="dropdown-item" type="button">
											<a href="/invoice/trahang">Trả hàng </a>
										</button>
									</div>
								</div>
							</div>
						...
						<div class="order-block">
							<table class="order-block__table">
								...
								<tbody>
									<c:forEach items="${listhd}" var="orders">
										<tr>
											<td>${orders.id}</td>
											<td>${orders.order_date}</td>
											<td>${orders.status.status_name}</td>
											<td>${orders.total_amount}</td>
											<td><a href="/chitiethoadon/${orders.id}">chi tiết</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
							<div class="product-rating__list-pagination">
								<ul class="list-inline-pagination">
									<li ng-if="page>0" class="first-page"><a
										ng-click="pages_click(0)">Trang đầu </a></li>
									<li ng-if="page>0"><a class="pagination-arrow"
										ng-click="pages_click(0,1)"><span class="icon-ic_back"></span></a></li>
									<li ng-repeat="item in pages"><a
										ng-class="item.id == page? 'current' : ''"
										ng-click="pages_click(item.id)">[[item.name]]</a></li>
									<li ng-if="page>5"><a class="current"
										ng-click="pages_click(page)">[[page]]</a></li>
									<li ng-if="page<pageMax"><a class="pagination-arrow"
										ng-click="pages_click(0,2)"><span class="icon-ic_next-1"></span></a></li>
									<li ng-if="page<pageMax" class="last-page"><a
										ng-click="pages_click(pageMax)">Trang cuối </a></li>
								</ul>
							</div>
						</div>
					</div>
