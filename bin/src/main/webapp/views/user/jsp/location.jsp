...
<title>Cập nhật địa chỉ | IVY moda</title>
<link rel="canonical" href="https://ivymoda.com/customer/address_list" />
<meta property="og:url"
	content="https://ivymoda.com/customer/address_list" />
<meta property="og:title" content="Cập nhật địa chỉ | IVY moda" />
<meta property="og:image"
	content="https://pubcdn.ivymoda.com/files/news/2023/11/02/a98f68c65fefee040c603dc5a41b2a7b.jpg" />
...
<script type="text/javascript">
	...
	var guest_user = 'guest:0944120332';
	var static_url_product = 'https://pubcdn.ivymoda.com/files/product/';
	var now = parseDateTime('2023-11-15 15:01:52');
...
<script type="application/ld+json">
        {
            ...
            "logo": " https://pubcdn3.ivymoda.com/images/logo.png ",
            "image": " https://pubcdn3.ivymoda.com/images/logo.png ",
            "priceRange": "10$-50$",
...
<script type="application/ld+json">
        {
            ...
            "offers": {
                ...
                "itemCondition": "https://ivymoda.com/about/chinh-sach-doi-tra",
                "availability": "https://ivymoda.com/about/chinh-sach-bao-hanh",
                "seller": {
                    "@type": "Organization",
                    "name": "Store"
                }
...
<script async
	src="https://www.googletagmanager.com/gtag/js?id=UA-103241835-1"></script>
<script>
...
<script async
	src="https://www.googletagmanager.com/gtag/js?id=G-0L5GK8LELS"></script>
<script>
...
<script>
	...
	})(window, document, 'script', 'dataLayer', 'GTM-KF775BP');
</script>
...
<body>
			...
			<div class="breadcrumb-products">
				<ol class="breadcrumb__list">
					<li class="breadcrumb__item"><a class="breadcrumb__link"
						href="https://ivymoda.com/">Trang chủ</a></li>
					<li class="breadcrumb__item"><a
						href="https://ivymoda.com/customer/address_list"
						class="breadcrumb__link" title="Danh sách địa chỉ">Danh sách
							địa chỉ</a></li>
				</ol>
			</div>

			<div ng-app="myApp" ng-controller="addressCtrl">
				<div class="add-address" id="fancybox-popup">
					<h3>[[title]]</h3>
					<!--    <form class="row" action="">-->
					<div class="col-md-6 form-group">
						<input class="form-control" type="text" name=""
							ng-model="address_display_name" placeholder="Họ tên" />
					</div>
					<div class="col-md-6 form-group">
						<input class="form-control" type="text" name=""
							ng-model="address_phone" placeholder="Số điện thoại" />
					</div>
					<div class="col-md-6 form-group">
						<select id="province_city" class="form-control" type="text"
							name="" ng-model="region_id" id="register_region_id">

						</select>
					</div>
					<div class="col-md-6 form-group">
						<select id="district" class="form-control" type="text" name=""
							ng-model="city_id" id="register_city_id">

						</select>
					</div>
					<div class="col-md-12 form-group">
						<select id="wards" class="form-control" type="text" name=""
							ng-model="vnward_id" id="vnward_id">
						</select>
					</div>
					<div class="col-md-12 form-group">
						<input class="form-control" type="text" name=""
							placeholder="Địa chỉ" ng-model="address" />
					</div>
					<div class="col-md-12 form-group">
						<label class="form-radio"> <input
							class="form-radio__input" name="address_type_home" type="radio"
							ng-model="address_type_home" ng-checked="address_type_checked1"
							ng-value="1" /><span class="form-radio__label">Nhà/chung
								cư</span>
						</label> <label class="form-radio"> <input
							class="form-radio__input" name="address_type_home" type="radio"
							ng-model="address_type_home" ng-checked="address_type_checked0"
							ng-value="0" /><span class="form-radio__label">Cơ
								quan/công ty</span>
						</label>
					</div>
					<div class="col-md-12 form-group">
						<label class="form-checkbox"> <input
							class="form-checkbox__input" type="checkbox"
							ng-checked="address_active_checked" ng-model="address_active"
							ng-true-value="1" ng-false-value="0" /><span
							class="form-checkbox__label">Đặt làm mặc định</span>
						</label>
					</div>
					<div class="col-md-12 form-button">
						<button class="btn btn--large" ng-click="save()">[[title]]</button>
					</div>
					<!--    </form>-->
				</div>

				<div class="order-wrapper mt-40 my-address">
					<div class="container">
						<div class="row">
								...
								<div class="order-sidemenu block-border">
									<div class="order-sidemenu__user">
										...
										<div class="order-sidemenu__user-name">
											<p>Võ Vũ Trường Giang</p>
										</div>
									</div>
									<div class="order-sidemenu__menu">
										<ul>
											<li class="active"><a href="/views/info"><span
													class="icon-ic_avatar-1"></span>Thông tin tài khoản</a></li>
											<li class=""><a href=""><span
													class="icon-ic_padlock"></span>Lịch sử đăng nhập</a></li>

											<li class=""><a href="/views/manager-order"><span
													class="icon-ic_reload"></span>Quản lý đơn hàng</a></li>
											<li class=""><a href="/views/adress"><span
													class="icon-ic_placeholder"></span>Sổ địa chỉ</a></li>
											<li class=""><a href="/views/viewed-products"><span
													class="icon-ic_glasses"></span>Sản phẩm đã xem</a></li>
											<li class=""><a href="/views/favorite-products"><span
													class="icon-ic_heart"></span>Sản phẩm yêu thích</a></li>
											<li class=""><a href="/views/product-Q&A"><span
													class="icon-ic_headphones"></span>Hỏi đáp sản phẩm</a></li>
											<li class=""><a href="/views/support"><span
													class="icon-ic_hand"></span>Hỗ trợ - IVY</a></li>
										</ul>
									</div>
									...
									<!--                        <li role="presentation" class=""><a href="https://ivymoda.com/customer/info" aria-controls="bangthongtintaikhoan">Bảng thông tin tài khoản</a></li>-->
									<!--                        <li role="presentation" class="active"><a href="https://ivymoda.com/customer/address_list" aria-controls="sodiachi">Địa chỉ nhận hàng</a></li>-->
									<!--                        <li role="presentation" class=""><a href="https://ivymoda.com/customer/order_list/" aria-controls="quanlydonhang">Quản lý đơn hàng</a></li>-->
									<!--                    </ul>-->
									<!--                </div>-->
									<!--            </div>-->
									<!--        </div>-->
							...
							<div class="col-lg-8 col-xl">
								<div class="order-block__title wallet-address__title">
									<h3>Sổ địa chỉ</h3>
									<button ng-click="add()"
										class="btn btn--large js-fancybox-button" data-fancybox
										data-src="#fancybox-popup">
									...
									<div class="row">
										<div class="col-md-6" style="margin-bottom: 10px">
											<div class="block-border" style="padding: 32px 13px;">
												<h4 class="text-elipsis-2"
													style="display: -webkit-box; max-width: 250px; min-height: auto; font-size: 14px;">
													Trường Giang <span>(Nhà riêng)</span>
												</h4>
												<p class="phone-checkout">
													<span>Điện thoại:</span> <span>0944120332</span>
												</p>
												<p class="address-checkout text-elipsis-2"
													style="display: -webkit-box">
													<span>Địa chỉ:</span> <span>105/3 Nguyễn Thị Tú ,
														Bình Hưng Hòa B, Bình Tân</span>
												</p>
												<div class="checkout-address-delivery__action"
													style="right: 15px">
													<button style="margin-right: 2px"
														class="btn js-fancybox-button" data-fancybox
														data-src="#fancybox-popup" ng-click="edit(953020)">
														<span>Sửa</span>
													</button>
													<span ng-click="active(953020)" class="btn btn--large"
														style="text-transform: none;">Mặc định</span>
												</div>
											</div>
										</div>
									</div>
	...
	<div class="nav-bottom justify-content-center">
		<div class="item-nav-bottom">
			<div class="item-nav">
				<i class="icon-ic_search"></i> <a class="link-nav-bottom" href="#">Tìm
					kiếm</a>
			</div>
			<div class="sub-item-nav sub-item-nav-search">
				<form method="get" action="https://ivymoda.com/tim-kiem"
					...
					<div class="quick-search">
						<div class="item-searchs">
							...
							<div class="item-side-size">
								<label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=Đầm" class="item-sub-title">Đầm</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=trễ+vai"
									class="item-sub-title">trễ vai</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=&Aacute;o+kho&aacute;c"
									class="item-sub-title">&Aacute;o kho&aacute;c</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=Quần"
									class="item-sub-title">Quần</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=&Aacute;o+sơ+mi"
									class="item-sub-title">&Aacute;o sơ mi</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=Vest"
									class="item-sub-title">Vest</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=parka"
									class="item-sub-title">parka</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=tweed"
									class="item-sub-title">tweed</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=croptop"
									class="item-sub-title">croptop</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=Ch&acirc;n+v&aacute;y"
									class="item-sub-title">Ch&acirc;n v&aacute;y</a>
								</label> <label class="item-sub-list po-relative mb-2"> <a
									href="https://ivymoda.com/timkiem?q=l&ocirc;ng+cừu"
									class="item-sub-title">l&ocirc;ng cừu</a>
								</label>
							</div>
						</div>
					</div>
		...
		<!--<div class="item-nav-bottom">
		<div class="item-nav">
			<i class="icon-ic_wallet"></i>
			<a class="link-nav-bottom" href="#">Ví</a>
		</div>
		<div class="sub-item-nav">
			<div class="sub-action sub-action-wallet">
				<div class="top-action">
					<h3>Ví IVY</h3>
					<p class="balance">Số dư: <strong>0VND</strong></p>
				</div>
				<ul>
					<li><a href="https://ivymoda.com/customer/wallet_list">Thông tin ví</a></li>
					<li><a href="https://ivymoda.com/customer/wallet_pin">Mã PIN</a></li>
					<li><a href="https://ivymoda.com/customer/wallet_add">Nạp tiền</a></li>
					<li><a href="https://ivymoda.com/customer/wallet_buy_card">Mua thẻ cào</a></li>
				</ul>
			</div>
		</div>
	</div>-->
		<div class="item-nav-bottom">
			<div class="item-nav">
				<i class="icon-ic_headphones"></i> <a class="link-nav-bottom"
					href="#">Trợ giúp</a>
			</div>
			<div class="sub-item-nav">
				<div class="sub-action ">
					...
					<ul>
						<li><a href="tel:02466623434"><i
								class="icon-ic_phone-call"></i>Hotline</a></li>
						<li><a href="javascript:openCsChatBox();"><i
								class="icon-ic_chat-2"></i>Live Chat</a></li>
						<li><a href="http://messenger.com/t/thoitrangivymoda"><i
								class="icon-ic_reload"></i>Messenger</a></li>
						<li><a href="mailto:saleadmin@ivy.com.vn"><i
								class="icon-ic_envelope"></i>Email</a></li>
						<li><a href="https://ivymoda.com/page/order_find"><i
								class="fa fa-paw"></i>Tra cứu đơn hàng</a></li>
						<li><a href="https://ivymoda.com/lien-he"><i
								class="fa fa-wechat"></i>Liên hệ</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="item-nav-bottom">
			<div class="item-nav">
				<i class="icon-ic_avatar-1"></i> <a class="link-nav-bottom" href="#">Tài
					khoản</a>
			</div>
			<div class="sub-item-nav">
				<div class="sub-action">
					...
					<ul>
						<li><a href="https://ivymoda.com/customer/info"><i
								class="icon-ic_avatar-1"></i>Thông tin tài khoản</a></li>
						<li><a href="https://ivymoda.com/customer/order_list"><i
								class="icon-ic_reload"></i>Quản lý đơn hàng</a></li>
						<li><a href="https://ivymoda.com/customer/address_list"><i
						...
						<li><a href="https://ivymoda.com/customer/san-pham-da-xem"><i
								class="icon-ic_glasses"></i>Sản phẩm đã xem</a></li>
						<li><a href="https://ivymoda.com/customer/san-pham-yeu-thich"><i
								class="icon-ic_heart"></i>Sản phẩm yêu thích</a></li>
						<li><a href="https://ivymoda.com/customer/question"><i
								class="icon-ic_headphones"></i>Hỏi đáp sản phẩm</a></li>
						<li><a href="https://ivymoda.com/ivy-support/danh-sach"><i
						...
						<li><a href="https://ivymoda.com/customer/logout"><i
...
-->
	<div class="modal-gift" id="modal-gift-ao-nam">
		<a href="javascript:void(0);"> <img
			onclick="document.location.href='https://ivymoda.com/danh-muc/quoc-te-gia-dinh-hang-tang'"
			src="https://ivymoda.com/assets/images/popup/popup-c.jpg" alt="gift">
		</a>
	</div>
	<!---->
	<div class="add-card-size" id="fancybox-add-to-cart">
		...
		<p class="notify__add-to-cart--success text-uppercase">Thêm vào
			giỏ hàng thành công !</p>
	</div>
	<div id="overlay"></div>
	...
	<script>
        ...
        async function getProvinces() {
            try {
                const response = await fetch('user/json/provinces.json');
        ...
        function fillComboBox(comboBox, data) {
            comboBox.innerHTML = '<option value="Chọn">Chọn</option>';
            data.forEach((item) => {
        ...
        function fillDistrictComboBox(selectedProvinceCode) {
            const selectedProvince = provincesData.find(province => province.code == selectedProvinceCode);
            const districtComboBox = document.getElementById('district');
            const xaPhuongComboBox = document.getElementById('wards');

            if (selectedProvince) {
                const districtsData = selectedProvince.districts;
                fillComboBox(districtComboBox, districtsData);
            } else {
                districtComboBox.innerHTML = '<option value="Chọn">Chọn</option>';
                xaPhuongComboBox.innerHTML = '<option value="Chọn">Chọn</option>';
            }
        }

        function fillWardComboBox(selectedDistrictCode) {
            const selectedProvinceCode = document.getElementById('province_city').value;
            const selectedProvince = provincesData.find(province => province.code == selectedProvinceCode);
            ...
            if (selectedDistrict) {
                ...
                fillComboBox(xaPhuongComboBox, wardsData);
            } else {
                xaPhuongComboBox.innerHTML = '<option value="Chọn">Chọn</option>';
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            try {
                ...
                const provinceComboBox = document.getElementById('province_city');
                fillComboBox(provinceComboBox, provincesData);
            } catch (error) {
        ...
        document.getElementById('province_city').addEventListener('change', function () {
            ...
            fillDistrictComboBox(selectedProvinceCode);
        });

        document.getElementById('district').addEventListener('change', function () {
            const selectedDistrictCode = this.value;
            fillWardComboBox(selectedDistrictCode);
        });
    </script>
</body>
